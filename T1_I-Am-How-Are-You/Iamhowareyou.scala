...
object Iamhowareyou {
  def main(args: Array[String]): Unit = { // need to convert to basic io
    val standIn = new Scanner(System.in)
    System.out.println("I am Ascalaprogam.  How are you (good/any other typed input)? \n")
    val temp: String = standIn.nextLine()
    if (temp.contains("good")) System.out.println("Great!")
    else System.out.println("Sounds like you are definitely not good right now.")
    ...
    standIn.nextLine()
    System.out.println("Well it is now my favorite number and definition of truth.")
  }
}
